...
function AuthForm({ formTitle, submitFormButton, linkDescription, submitFormButtonAction, routeName, showNameInput }: AuthFormProps) {
    ...
    return (
        <div className="flex flex-col items-center bg-[#1C1C1C] rounded-md p-7">
            <header className="flex flex-col items-center" >
                ...
                <Heading size="lg" className="mt-2 text-gray-500">Connect Now</Heading>
                <Text size="md" className="mt-1 text-gray-500">{formTitle}</Text>
            </header>

            <form onSubmit={handleSubmit} className="p-x-8  flex flex-col gap-3 items-stretch h-screen">
                {showNameInput && (
                ...
                <Button type="submit" disabled={!formValid}>{submitFormButton}</Button>
